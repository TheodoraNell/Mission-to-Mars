...
def scrape_all():
    ...
    # note: "browser"  is the variable and "Browser" is the name of a parameter (they do not need to match, just happen to here)
    # note: "headless" set to True so browser is run without seeing scraping in action
